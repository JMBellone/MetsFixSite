// api/latestupdates.js — 7 most recent articles from NY Post, SNY, MLB.com

const FEEDS = [
  { url: 'https://www.mlb.com/mets/feeds/news/rss.xml', source: 'MLB.com' },
  { url: 'https://sny.tv/mets-feed', source: 'SNY' },
  { url: 'https://nypost.com/tag/new-york-mets/feed/', source: 'NY Post' },
]
...
module.exports = async function handler(req, res) {
  ...
  res.status(200).json({ articles: deduped.slice(0, 7) })
}
